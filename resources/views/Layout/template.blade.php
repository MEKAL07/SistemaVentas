...
<body>
            ...
            <nav id="navMenu">
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            <li><a href="{{url('cliente/registrar')}}">Registro de cliente</a>
                            </li><li>
                            <a href="{{url('cliente/ver')}}">ver cliente</a>
                            </li>
                        </ul>
                    </li--><li>
                        <a href=""><span class="icon-users"></span>Persona</a>
                        <ul>
                            <li><a href="{{url('persona/registrar')}}">Registro de Persona</a>
                            </li><li>
                            <a href="{{url('persona/ver')}}">ver Persona</a>
                            </li>
                        </ul>
                    </li><li>
                        <a href=""><span class="icon-users"></span>Proveedor</a>
                        <ul>
                            <li><a href="{{url('proveedor/registrar')}}">Registro de Proveedores</a>
                            </li><li>
                            <a href="{{url('proveedor/ver')}}">ver Proveedores</a>
                            </li>
                        </ul>
                    </li><li>
                        <a href=""><span class="icon-users"></span>Categoria</a>
                        <ul>
                            <li><a href="{{url('categoria/registrar')}}">Registro de Categoria</a>
                            </li><li>
                            <a href="{{url('categoria/ver')}}">ver Categoria</a>
                            </li>
                        </ul>
                    </li><!--li>    
    ...
    <footer>
        <marquee>jainormontes@gmail.com</maquee>
    </footer>
</body>
</html>